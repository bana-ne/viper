...
# =============================================================================
""" Description:
    Rules specific to transform the output after aligning and counting files from the EVAdb pipeline 
    at the IHG group at the Institute of Neurogenomics, Helmholtz Zentrum Munich
    
    The pipeline also aligns reads with STAR and creates count files with HTseq.
"""
# =============================================================================
